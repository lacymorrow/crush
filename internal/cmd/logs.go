...
var logsCmd = &cobra.Command{
	Use:   "logs",
	Short: "View lash logs",
	Long:  `View the logs generated by Lash. This command allows you to see the log output for debugging and monitoring.`,
...
func followLogs(ctx context.Context, logsFile string, tailLines int) error {
	// Special-case: tail 0 means "follow from now" (do not print historical lines)
	if tailLines <= 0 {
	...
	// Default: show last N lines, then follow
	t, err := tail.TailFile(logsFile, tail.Config{
		Follow: false,
		ReOpen: false,
		Logger: tail.DiscardingLogger,
